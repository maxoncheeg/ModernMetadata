...
namespace ModernMetadata.Model.Metadata.Readers
{
    public class MenuConfigReader : IMenuConfigReader
    {
        ...
        /// </summary>
        /// <param name="factory">Фабрика методов для MenuItem</param>
        ...
        public IMenuData ReadMenuData(IUserMenuData userMenuData)
        {
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    // Получаем конкретный метод по имени из фабрики.
                    RoutedEventHandler? method = isStatusExist && status == ItemStatus.NotEnabledVisible ? null : _factory.GetMenuMethod(methodName);
